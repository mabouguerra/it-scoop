...
export default function Paginator({ currentPage, pageCount }) {
  return (
    <div className="grid grid-cols-2 mt-6 font-bold text-gray-900 dark:hover:text-gray-300 hover:text-gray-700 dark:text-gray-100 sm:pb-36 pb-28 lg:pb-40 sm:text-lg ">
