  ...
  return (
    <div className="flex items-center py-4">
      ...
      <div>
        ...
        <p className="mt-2 text-sm font-medium text-gray-700 dark:text-gray-300 sm:text-base lg:mt-4 line-clamp-3 sm:line-clamp-none">
          {excerpt} <span>...</span>
        </p>
        <Link href={url}>
          <a className="inline-block mt-2 text-base font-bold text-red-600 dark:text-red-400 dark:hover:text-red-600 hover:text-red-500 sm:text-lg">
            طالع المزيد ←
          </a>
        </Link>
      </div>
